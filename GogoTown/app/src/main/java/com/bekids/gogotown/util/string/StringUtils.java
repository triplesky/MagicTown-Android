package com.bekids.gogotown.util.string;
...
public final class StringUtils {
    ...
    public static boolean isTrimEmpty(final String... params) {
    ...
    public static String getString(@StringRes int id, Context context) {
        return getString(id, context, (Object[]) null);
    }
     ...
     * @return the string value associated with a particular resource ID.
     */
    public static String getString(@StringRes int id, Context context, Object... formatArgs) {
        try {
